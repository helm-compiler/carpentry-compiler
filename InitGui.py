...
class PartDesignWorkbench ( Workbench ):
    ...
    def __init__(self):
        self.__class__.Icon = FreeCAD.getResourceDir() + "Mod/PartDesign/Resources/icons/Carpentry.svg"
        self.__class__.MenuText = "Carpentry"
        self.__class__.ToolTip = "Woodwork Design workbench"
