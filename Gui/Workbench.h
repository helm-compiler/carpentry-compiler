...
public:
	Workbench(const string& config_file= "");
  ...
  void AddFeatureToCheck(PartDesign::Feature* f);

  CodeEditor* GetCodeEditor();

  ToolsConfiguration* GetToolsConfig();
  ...
  PHELM *langCompiler;
  PCE* pce;
  std::vector<PartDesign::Feature*> toCheck;
...
private:
  ...
  /// Check all the added feature are suitable or not
  void CheckFeatures();
