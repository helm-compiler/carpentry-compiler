...
PROPERTY_SOURCE(PartDesignGui::ViewProviderDatumVariable,PartDesignGui::ViewProviderDatum)

ViewProviderDatumVariable::ViewProviderDatumVariable()
{
    sPixmap = "PartDesign_Variable.svg";
...
void ViewProviderDatumVariable::attach ( App::DocumentObject *obj ) {
    ViewProviderDatum::attach ( obj );
}

void ViewProviderDatumVariable::onChanged (const App::Property* prop) {
